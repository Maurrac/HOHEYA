        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="card cardbox">
                    <div class="card-header text-center">Inscription en tant que Propriétaire de
                        logement</div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <form id="login-nav" action="{{ route('proprietaire.register') }}" method="POST"
                                enctype="multipart/form-data" role="form" class="form" accept-charset="UTF-8">
                                @csrf
                                <div class="form-group">
                                ...
                                <!-- document -->
                                <div class="form-group">
                                    <label for="document" class="sr-only">Preuve de propriété</label>
                                ...
                                <!-- Submit -->
                                <div class="form-group">
                                    <button id="reg_submit" class="btn btn-block btn-primary"
                                        disabled="disabled">Créer mon compte</button>
                        ...
                        <div class="bottom text-center">
                            Avez-vous déjà un compte? <a
                                href="{{ route('proprietaire.connexion') }}"><b>Connexion</b></a>
                        </div>
                    </div>
                </div>
            </div>
